...
public interface ProductService { //ProductService 구현도
    ...
    List<ProductDTO> productDetailByMainCategory(Long mainCategoryId);
...
//    Slice<ProductDTO> viewProductsSlice(int pageNo);

    List<ProductDTO> viewProductsByMainCategoryName(String searchValue);
